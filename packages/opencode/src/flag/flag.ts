export namespace Flag {
  ...
  export const OPENCODE_DISABLED_PLUGINS = process.env["OPENCODE_DISABLED_PLUGINS"]
  export const OPENCODE_ENABLED_PLUGINS = process.env["OPENCODE_ENABLED_PLUGINS"]
